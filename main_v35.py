...
BOT_VERSION = "v35"
BOT_CHANGELOG = "Fix race condition khi cấp danh hiệu độc quyền top-1 (Vua Cày Điểm/Vô Song CP/Vua Hardest/Vua Try Hard/Vua Verify Challenge) bằng thao tác đọc-ghi nguyên tử; fix lỗi tên level không được encode khi gọi GDBrowser; cảnh báo sớm nếu quên cấu hình ADMIN_LOG_CHANNEL_ID."
